      ...
      <form
        ...
        onSubmit={(e) => {
          ...
          if (!image && desciption.current.value.length <= 0) {
            handleShowToast("error", "Please provide either an image or a description");
          } else {
        ...
        <div className="dynamic-primary rounded-md p-3 h-full flex flex-col gap-3 mb-16 sm:mb-28 lg:mb-24">
          <div className="dynamic-secondary border-dashed border-2 border-d-accent flex grow justify-center content-center">
            <div class="flex items-center justify-center w-full">
              <label for="dropzone-file" className="flex flex-col items-center justify-center w-full h-64 border-2 border-none cursor-pointer dynamic-secondary hover:bg-gray-300 dark:hover:bg-gray-700 relative">
                <div className={`h-full w-full absolute ${previewImage ? "block" : "hidden"}`}>
                  <img src={previewImage} alt="upload image" className="h-full w-full object-contain " />
                </div>
          ...
          <div className="flex flex-col grow">
            ...
            <input
              ...
              autoComplete="off"
            />
            <button type="submit" className="w-24 h-10 opacity-90 hover:opacity-100 bg-l-accent dark:bg-d-accent rounded-md mt-3 place-self-end">
              Post
            </button>
          </div>
        </div>
