            ...
            /> */}
					...
					<div className="flex flex-col grow">
						<textarea
							...
							cols="10"
							rows="5"
							className="rounded-md min-h-1 bg-d-secondary text-d-text p-2 text-lg mb-2 outline-none focus:ring-2 focus:ring-blue-500 transition-300 md:h-"
							placeholder="What's on your mind?"
						></textarea>

						<input
							type="text"
							className="rounded-md transition-300 outline-none focus:ring-2 focus:ring-blue-500 bg-d-secondary h-8 p-3 mt-1 text-d-text "
							placeholder="#hashtags"
						/>
						<button className="w-24 h-10 text-d-text opacity-90 bg-d-accent rounded-md mt-3 place-self-end transition-all hover:opacity-100">
							Post
						</button>
					</div>
				</div>
