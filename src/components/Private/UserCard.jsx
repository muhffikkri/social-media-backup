	...
	return (
		<>
			<div className="w-full max-h-[70px] flex dynamic-primary p-3 rounded-lg items-center justify-between gap-3 shadow-lg dark:shadow-none mb-2 cursor-pointer">
				...
				<button className="bg-l-accent dark:bg-d-accent p-2 rounded-md w-24 font-semibold dark:text-d-text text-l-secondary text-shadow hover:bg-[#1070ed] dark:hover:bg-[#1070ed]">
					Follow
				</button>
			</div>
		</>
