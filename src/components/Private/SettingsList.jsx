...
export default function SettingsMenu({
	...
	return (
		<>
			<div
				ref={settingsRef}
				className="dynamic-primary border-solid border-[0.5px] border-d-text dark:border-opacity-20 absolute right-[5px] xl:bottom-[-105px] md:bottom-[-88px] bottom-[-88px] xl:w-40 w-36 shadow-2xl rounded-lg animate-slide-bottom overflow-hidden "
			>
				<ul>
					<Link
						to="/about"
