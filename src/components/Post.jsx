...
export default function Post() {
  ...
  return (
    <>
      {commentActive ? <CommentsSection setCommentActive={setCommentActive} /> : ""}
      <div className="w-full h-auto flex flex-col bg-d-primary rounded-xl mb-2">
        <div className="flex flex-col p-4 pb-2">
          <div className="w-full h-14 flex items-center" id="headerPost">
            <div className="w-12 h-12 rounded-full bg-d-bgc cursor-pointer" id="image"></div>
          ...
          <div className="w-full h-auto pt-2">
            ...
            <p className="text-d-accent text-lg font-semibold py-1 cursor-pointer">#hashtags #kirim #socialmedia</p>
          </div>
        </div>
        ...
        <div className="w-full h-[40px] md:h-[50px] flex flex-row px-2 pb-2 md:pb-4 gap-1" id="likes">
          ...
          <div className="flex flex-row justify-center">
            <img src="./icons/d-comment.svg" alt="comment" className="cursor-pointer" onClick={() => setCommentActive(!commentActive)} />
