...
export default function Post() {
	...
	return (
		<>
			{commentActive ? (
				<CommentsSection setCommentActive={setCommentActive} />
			) : (
				""
			)}
			<div className="w-full h-auto flex flex-col bg-l-primary dark:bg-d-primary rounded-xl mb-2">
				<div className="flex flex-col p-4 pb-2">
					<div className="w-full h-14 flex items-center" id="headerPost">
						<div
							className="w-12 h-12 rounded-full bg-l-bgc dark:bg-d-bgc cursor-pointer"
							id="image"
						></div>
						<div
							className="flex flex-col px-2 text-l-text dark:text-d-text"
							id="nameAndLocation"
						>
							<p className="font-bold text-xl cursor-pointer text-l-text dark:text-d-text">
								Nama
							</p>
							<p className="font-semibold opacity-80 text-l-text dark:text-d-text">
								location
							</p>
						</div>
					</div>
					<div className="w-full h-auto pt-2">
						<p className="text-l-text dark:text-d-text text-lg text-left">
				...
				>
					<div className="flex flex-row justify-center leading-3">
						...
						/>
						<p className="text-l-text dark:text-d-text font-semibold text-lg pl-1 self-center">
							12
						</p>
					</div>
					<div className="flex flex-row justify-center">
						...
						/>
						<p className="text-l-text dark:text-d-text font-semibold text-lg pl-[6px] self-center">
							32
						</p>
					</div>
					<img
						src="./icons/d-share.svg"
						alt="share"
						className="cursor-pointer"
					/>
				</div>
