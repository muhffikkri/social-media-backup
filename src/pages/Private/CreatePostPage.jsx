...
export default function CreatePostPage({ handleShowToast }) {
  ...
  return (
    <>
      ...
      >
        <div className="dynamic-primary rounded-md p-3 h-full flex flex-col gap-3 mb-16 sm:mb-28 lg:mb-20 border-l-secondary border-2 shadow-lg dark:border-d-primary">
          <div className="dynamic-secondary border-dashed border-2 border-d-accent flex grow justify-center content-center">
            <div class="flex items-center justify-center w-full">
              <label
                for="dropzone-file"
                className="flex flex-col items-center justify-center w-full h-60 border-2 border-none cursor-pointer dynamic-secondary hover:bg-gray-300 dark:hover:bg-gray-700 relative"
              >
                <div
          ...
          <div className="flex flex-col grow">
            <textarea
              ...
              ref={desciption}
              rows="5"
              className="rounded-md min-h-1 dynamic-secondary dynamic-text p-2 h-32 text-lg mb-2 focus:ring-2 focus:ring-d-accent outline-none"
            ...
            <button
              type="submit"
              className="w-24 max-h-10 h-9 dynamic-text hover:opacity-100 bg-l-accent dark:bg-d-accent rounded-md mt-3 place-self-end font-semibold hover:bg-[#1070ed] dark:hover:bg-[#1070ed]"
            >
              Post
            </button>
          </div>
