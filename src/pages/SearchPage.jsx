        ...
        <div className="font-open-sans w-full py-2 px-4 mx-auto ">
          ...
          <div className="w-full h-auto mt-2 " id="postsContainer">
            <div className="w-full h-auto flex mb-4">
              <input type="text" className="rounded-xl dynamic-primary w-full h-12 p-2 pl-4 dynamic-text text-lg focus:ring-2 focus:ring-d-accent outline-none" placeholder="Search Your Friends" />
            </div>
