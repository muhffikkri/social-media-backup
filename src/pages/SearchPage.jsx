              ...
              <form action="post" className="w-full h-12 relative">
                <label htmlFor="search">
                  ...
                  <input
                    ...
                    name="search"
                    id="search"
                    className="rounded-xl dynamic-primary w-full h-12 p-2 pl-8 dynamic-text text-lg hover:ring-1 hover:ring-d-accent focus:ring-2 focus:ring-d-accent outline-none"
